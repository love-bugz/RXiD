        ...
        return (
            <Animated.View style={[styles.formControl, props.formControlStyle]}>
                <Animated.Text
                    style={[
                        styles.label,
                        (inputState.touched || inputState.focus) &&
                            styles.endLabel,
                ...
                <TextInput
                    onSubmitEditing={text =>
                        props.submit ? props.submit(text) : null
                    }
                    onFocus={() => {
                            ...
                            style={[
                                styles.errorText,
                                {
                                    textAlign: props.right
                                        ...
                                        : undefined,
                                    color:
                                        props.borderColor && inputState.focus
                                            ? props.borderColor
                                            : undefined,
                                },
        ...
        <View style={[styles.formControl, props.formControlStyle]}>
            ...
            <TextInput
                ...
                style={[
                    ...
                    {
                        borderBottomColor:
                            inputState.focus && props.borderColor
                                ? props.borderColor
                                : undefined,
                    },
                    props.inputStyle,
            ...
            {!inputState.isValid && inputState.touched && props.errorText && (
                <View
                    style={[styles.errorContainer, props.errorContainerStyle]}>
                    <Text
                        style={[
                            styles.errorText,
